...
<!-- Mirrored from demo.smartaddons.com/templates/html/revo/product-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Feb 2020 19:58:56 GMT -->
...
<head>
    ...
    <!-- Libs CSS
    ============================================ -->
    <link rel="stylesheet" href="/shop/css/bootstrap/css/bootstrap.min.css">
    <link href="/shop/css/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <link href="/shop/js/datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet">
    <link href="/shop/js/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="/shop/css/themecss/lib.css" rel="stylesheet">
    <link href="/shop/js/jquery-ui/jquery-ui.min.css" rel="stylesheet">
    <link href="/shop/js/minicolors/miniColors.css" rel="stylesheet">

    <!-- Theme CSS
    ============================================ -->
    <link href="/shop/css/themecss/so_searchpro.css" rel="stylesheet">
    <link href="/shop/css/themecss/so_megamenu.css" rel="stylesheet">
    <link href="/shop/css/themecss/so-categories.css" rel="stylesheet">
    <link href="/shop/css/themecss/so-listing-tabs.css" rel="stylesheet">
    <link href="/shop/css/themecss/so-newletter-popup.css" rel="stylesheet">

    <link href="/shop/css/footer/footer1.css" rel="stylesheet">
    <link href="/shop/css/header/header1.css" rel="stylesheet">
    <link id="color_scheme" href="/shop/css/theme.css" rel="stylesheet">
    <link href="/shop/css/responsive.css" rel="stylesheet">
                        ...
                        <ul class="top-link list-inline">
                            ...
                            <li class="language">
                                <div class="btn-group languages-block ">
                                    <form action="http://demo.smartaddons.com/templates/html/revo/index.html" method="post" enctype="multipart/form-data" id="bt-language">
                                        <a class="btn btn-link dropdown-toggle" data-toggle="dropdown">
                                            <img src="/shop/image/catalog/flags/gb.png" alt="English" title="English">
                                            <span class="">English</span>
                                            <span class="fa fa-angle-down"></span>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li><a href="index.html"><img class="image_flag" src="/shop/image/catalog/flags/gb.png" alt="English" title="English" /> English </a></li>
                                            <li> <a href="index.html"> <img class="image_flag" src="/shop/image/catalog/flags/ar.png" alt="Arabic" title="Arabic" /> Arabic </a> </li>
                                        </ul>
                                    </form>
                                </div>
                            ...
                            <li class="currency">
                                <div class="btn-group currencies-block">
                                    <form action="http://demo.smartaddons.com/templates/html/revo/index.html" method="post" enctype="multipart/form-data" id="currency">
                                        <a class="btn btn-link dropdown-toggle" data-toggle="dropdown">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="navbar-logo col-md-2 col-sm-3 col-xs-10">
                        <div class="logo"><a href="index.html"><img src="/shop/image/catalog/logo.png" title="Your Store" alt="Your Store" /></a></div>
                    </div>
                    <!-- //end Logo -->
                                                    ...
                                                    <ul class="megamenu" data-transition="slide" data-animationtime="250">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <a href="index.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-1.jpg" alt="">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <a href="home2.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-2.jpg" alt="">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <a href="home3.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-3.jpg" alt="">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <a href="home4.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-4.jpg" alt="">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <a href="home4.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-5.jpg" alt="">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <a href="home4.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-6.jpg" alt="">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <a href="home4.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-7.jpg" alt="">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <a href="home4.html" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/catalog/menu/home-8.jpg" alt="">
                                                                        ...
                                                                        <!-- <div class="col-md-15">
                                                                            <a href="#" class="image-link">
                                                                                <span class="thumbnail">
                                                                                    <img class="img-responsive img-border" src="/shop/image/demo/feature/comming-soon.png" alt="">
                                                        ...
                                                        <li class="with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                ...
                                                                <img class="label-hot" src="/shop/image/catalog/menu/new-icon.png" alt="icon items">
                                                                <b class="caret"></b>
                                                            </a>
                                                        ...
                                                        <li class="with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                ...
                                                                <img class="label-hot" src="/shop/image/catalog/menu/hot-icon.png" alt="icon items">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <div class="row">
                                                                                <div class="col-md-3 img img1">
                                                                                    <a href="#"><img src="/shop/image/catalog/menu/megabanner/image-1.jpg" alt="banner1"></a>
                                                                                </div>
                                                                                <div class="col-md-3 img img2">
                                                                                    <a href="#"><img src="/shop/image/catalog/menu/megabanner/image-2.jpg" alt="banner2"></a>
                                                                                </div>
                                                                                <div class="col-md-3 img img3">
                                                                                    <a href="#"><img src="/shop/image/catalog/menu/megabanner/image-3.jpg" alt="banner3"></a>
                                                                                </div>
                                                                                <div class="col-md-3 img img4">
                                                                                    <a href="#"><img src="/shop/image/catalog/menu/megabanner/image-4.jpg" alt="banner4"></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="container-mega">
                                                        <ul class="megamenu">
                                                            <li class="item-vertical  with-sub-menu hover">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-6.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-1.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical  style1 with-sub-menu hover">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-2.png" alt="icon">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="row banner">
                                                                                    <a href="#">
                                                                                        <img src="/shop/image/catalog/menu/megabanner/vbanner1.jpg" alt="banner1">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <li class="item-vertical with-sub-menu hover">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-3.png" alt="icon">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="row banner">
                                                                                            <a href="#">
                                                                                                <img src="/shop/image/catalog/menu/megabanner/menu_bg2.jpg" alt="banner1">
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                            ...
                                                            <li class="item-vertical css-menu with-sub-menu hover">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-4.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-5.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-7.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical">
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-8.png" alt="icon">
                                                            ...
                                                            <li class="item-vertical" >
                                                                ...
                                                                <a href="#" class="clearfix">
                                                                    <span>
                                                                        <img src="/shop/image/catalog/menu/icons/icon-9.png" alt="icon">
                                                                        <strong>Accessories</strong>
                                                                    </span>
                            ...
                            <div class="header_search col-lg-6 col-md-8 col-sm-9 col-xs-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-search">
                                    <div id="sosearchpro" class="sosearchpro-wrapper so-search ">
                                        <form method="GET" action="http://demo.smartaddons.com/templates/html/revo/index.html">
                                                    ...
                                                    <table class="table table-striped">
                                                        ...
                                                        <tr>
                                                            <td class="text-center" style="width:70px">
                                                                <a href="product.html">
                                                                    <img src="/shop/image/catalog/demo/product/80/1.jpg" style="width:70px" alt="Yutculpa ullamcon" title="Yutculpa ullamco" class="preview">
                                                                </a>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="text-center" style="width:70px">
                                                                <a href="product.html">
                                                                    <img src="/shop/image/catalog/demo/product/80/2.jpg" style="width:70px" alt="Xancetta bresao" title="Xancetta bresao" class="preview">
                                                                </a>
                                                            </td>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 payment">
                    <img src="/shop/image/catalog/demo/payment/payment.png" alt="imgpayment">
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="/shop/js/jquery-2.2.4.min.js"></script>
<script type="text/javascript" src="/shop/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/shop/js/owl-carousel/owl.carousel.js"></script>
<script type="text/javascript" src="/shop/js/themejs/libs.js"></script>
<script type="text/javascript" src="/shop/js/unveil/jquery.unveil.js"></script>
<script type="text/javascript" src="/shop/js/countdown/jquery.countdown.min.js"></script>
<script type="text/javascript" src="/shop/js/dcjqaccordion/jquery.dcjqaccordion.2.8.min.js"></script>
<script type="text/javascript" src="/shop/js/datetimepicker/moment.js"></script>
<script type="text/javascript" src="/shop/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
...
<script type="text/javascript" src="/shop/js/themejs/homepage.js"></script>

<script type="text/javascript" src="/shop/js/themejs/so_megamenu.js"></script>
<script type="text/javascript" src="/shop/js/themejs/addtocart.js"></script>
<script type="text/javascript" src="/shop/js/themejs/application.js"></script>
<!--         -->
