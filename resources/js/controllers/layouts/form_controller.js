...
export default class extends Controller {
    ...
    submit(event) {
        ...
        const screenEventSubmit = new Event('app:screen-submit');
        ...
        axios.post(action, form, {
            ...
            .catch((error) => {
                ...
                if (error.response) {
                    ...
                    window.error('The application could not process your request.', 'Server error');
    ...
    animateButton() {
        ...
        buttonElement.innerHTML = `<i class="icon-spinner4 spinner mr-2"></i>${text}`;
    }
